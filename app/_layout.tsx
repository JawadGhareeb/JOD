...
import { AppSidebarProvider } from "@/src/providers/AppSidebarProvider";
...
export default function RootLayout() {
  ...
  return <QueryClientProvider client={queryClient}><GestureHandlerRootView style={{ flex: 1 }}><RTLProvider><SafeAreaProvider><ToastProvider><AuthGuardProvider><AppSidebarProvider><NotificationRuntimeBridge /><StatusBar style={isDark ? "light" : "dark"} translucent={false} backgroundColor={isDark ? "#1f222b" : "#FFFFFF"} /><Stack initialRouteName="index" screenOptions={{ headerShown: false }}><Stack.Screen name="index" /><Stack.Screen name="(auth)" /><Stack.Screen name="(tabs)" /><Stack.Screen name="apply/[id]" /><Stack.Screen name="author/[id]" /><Stack.Screen name="donate/[id]" /><Stack.Screen name="donations/[id]" /><Stack.Screen name="campaigns/[id]" /><Stack.Screen name="help-offers/[id]" /><Stack.Screen name="help-offers/create/[postId]" /><Stack.Screen name="blogs/[id]" /><Stack.Screen name="blogs/index" /><Stack.Screen name="about" /><Stack.Screen name="account-settings" /><Stack.Screen name="change-password" /><Stack.Screen name="edit-information" /><Stack.Screen name="help-center" /><Stack.Screen name="my-donations" /><Stack.Screen name="notifications/[id]" /><Stack.Screen name="posts/[id]" /><Stack.Screen name="saved-posts" /><Stack.Screen name="search" /><Stack.Screen name="terms-privacy" /></Stack></AppSidebarProvider></AuthGuardProvider></ToastProvider></SafeAreaProvider></RTLProvider></GestureHandlerRootView></QueryClientProvider>;
}
