...
export default function DonationDetailsPage() {
  ...
  const [confirmedAmount,setConfirmedAmount]=useState(""); const [cancelReason,setCancelReason]=useState("");
