    ...
    <KeyboardAvoider className="flex-1">
      <Container scrollable className="bg-light-100 dark:bg-dark-300" scrollViewProps={{ contentContainerStyle: { flexGrow: 1, paddingHorizontal: 16, paddingTop: 12, paddingBottom: 36 } }}>
        ...
        <View className="gap-2">
          ...
          {postQuery.isLoading ? <View className="gap-2"><CardSkeleton height={150} margin={0} /><CardSkeleton height={260} margin={0} /></View> : !post ? <Card padding="md"><Text size="sm" rtlAlign="center">تعذر العثور على فرصة التطوع المطلوبة.</Text></Card> : (
            <>
