        ...
        ListEmptyComponent={
          query.isLoading ? (
            ...
            <View className="items-center py-10">
              <Text size="sm" className="text-gray-500 dark:text-gray-300">لا توجد مقالات منشورة حالياً.</Text>
            </View>
          )
        }
        ListFooterComponent={query.isFetchingNextPage ? <BlogPostCardSkeleton /> : null}
      />
    </View>
  );
}
