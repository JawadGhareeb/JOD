...
export interface AuthSession extends TokenPayload { user: AuthUser; verificationRequired?: false }
...
export interface VerificationPendingPayload { verificationRequired: true; verificationCodeSent: boolean; verificationChannel: "email"; expiresIn: number; resendAvailableIn: number; user: AuthUser }
export interface ResendVerificationPayload { verificationRequired: true; verificationCodeSent: boolean; verificationChannel: "email"; expiresIn: number; resendAvailableIn: number }
export interface VerifyAccountInput { login: string; code: string }
